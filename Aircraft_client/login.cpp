...
//    this->setAttribute(Qt::WA_TranslucentBackground);
     ...
     ui->pushButton_changepwd->installEventFilter(this);
     ui->pushButton_regsiter->installEventFilter(this);
...
bool Login::eventFilter(QObject *object, QEvent *e)
{
    ...
    else if(e->type()==QEvent::MouseButtonPress&&object==ui->pushButton_changepwd){
        ChangePwd * s = new ChangePwd(this);
        s->show();
        qDebug()<<"修改密码";

    }
    else if(e->type()==QEvent::MouseButtonPress&&object==ui->pushButton_regsiter){
        Regsiter * s = new Regsiter(this);
        s->show();
        qDebug()<<"注册";
    }
    else if(e->type()==QEvent::MouseButtonPress&&object==ui->pushButton_login){
        try_login();
        qDebug()<<"登录";
    }
